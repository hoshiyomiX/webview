...
class MainActivity : AppCompatActivity() {
    ...
    private val batteryReceiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context, intent: Intent) {
            // Auto-update battery data when broadcast received
            webView.post {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        webView.settings.apply {
            ...
            // Mixed content mode (for local assets)
        ...
        // Register battery change listener
    ...
    override fun onConfigurationChanged(newConfig: Configuration) {
        ...
        // Notify WebView about theme change
    ...
    /**
     * JavaScript Bridge - Exposed to WebView
     */
    inner class AndroidBridge {
        
        /**
         * Get current system theme (dark/light)
         */
        @JavascriptInterface
        ...
        /**
         * Request root access (trigger su prompt)
         */
        @JavascriptInterface
